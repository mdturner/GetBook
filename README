...
Instructions:
The book is specified by using the bookid from the book's url, e.g. for _Temple and the Cosmos_ (http://maxwellinstitute.byu.edu/publications/books/?bookid=103), the bookid is 103.  The script will ask the user for the bookid, or it can be passed as an argument.  
